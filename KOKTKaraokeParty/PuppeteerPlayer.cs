...
public class PuppeteerPlayer : IPuppeteerPlayer
{
    ...
    private string GetAttributeFunction(string selector, string attribute)
    {
        return $@"(selector) => {{
    ...
    public async Task PauseKarafun()
    {
        if (_page != null)
        {
    ...
    public async Task ResumeKarafun()
    {
        if (_page != null)
        {
    ...
    public async Task ToggleYoutube()
    {
        if (_page != null)
        {
